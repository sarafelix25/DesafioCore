...
class ActivityMenu: AppCompatActivity(), PratoAdap.OnPratoClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar = setSupportActionBar(menuToolbar)
        getSupportActionBar()?.setDisplayShowTitleEnabled(false)
    }

    fun getPratos(): ArrayList<Prato>{
        val p1 = Prato("Salada com molho Gengibre", R.drawable.image4)
        val p2 = Prato("Sopa de Picles", R.drawable.image2)
        ...
        val p6 = Prato("Sorvete com calda de Pesto", R.drawable.image4)
